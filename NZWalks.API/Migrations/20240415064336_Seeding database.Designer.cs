...
namespace NZWalks.API.Migrations
{
    ...
    [Migration("20240415064336_Seeding database")]
            ...
            modelBuilder.Entity("NZWalks.API.Models.Domain.Difficulty", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("dfdc140a-39a8-418d-a848-6480157923f4"),
                            Name = "Easy"
                        },
                        new
                        {
                            ID = new Guid("6abf66fa-07fa-4f03-a5c0-f03433e86ebf"),
                            Name = "Medium"
                        },
                        new
                        {
                            ID = new Guid("dd73f916-5281-4437-b969-6993b805b7de"),
                            Name = "Hard"
                        });
                });
